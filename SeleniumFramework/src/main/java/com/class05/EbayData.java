...
public class EbayData extends ExampleBaseClass {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // 2. Create list of web element for each item
        ...
        for (WebElement element : listOfItems) {
            ...
            // If we do not find any information from seller we are handling the no such element exception
            try {
